...
class checkcontentTask extends sfBaseTask
{
  protected function configure()
  {
    ...
    $this->namespace        = '';
    $this->name             = 'checkcontent';
    $this->briefDescription = '';
    $this->detailedDescription = <<<EOF
The [checkcontent|INFO] task does things.
Call it with:

  [php symfony checkcontent|INFO]
EOF;
  }
  ...
  protected function execute($arguments = array(), $options = array())
  {
    ...
    $file_logger = new sfFileLogger($this->dispatcher, array(
    	'file' => $this->configuration->getRootDir().'/log/checkcontent.log'
    ));
