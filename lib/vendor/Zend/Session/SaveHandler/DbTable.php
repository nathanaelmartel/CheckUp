 ...
 */
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Db/Table/Row/Abstract.php';

/**
 * @see Zend_Config
 */
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Config.php';
    ...
    implements Zend_Session_SaveHandler_Interface
{
    ...
    public function __construct($config)
    {
        if ($config instanceof Zend_Config) {
             ...
             */
            require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Session/SaveHandler/Exception.php';
