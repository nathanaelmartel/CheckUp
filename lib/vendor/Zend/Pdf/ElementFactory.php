...
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Pdf/ElementFactory/Interface.php';
...
class Zend_Pdf_ElementFactory implements Zend_Pdf_ElementFactory_Interface
{
    ...
    {
        require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Pdf/ElementFactory/Proxy.php';
    ...
    public function listModifiedObjects($rootFactory = null)
    {
        ...
        $result = array();
        require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Pdf/UpdateInfoContainer.php';
