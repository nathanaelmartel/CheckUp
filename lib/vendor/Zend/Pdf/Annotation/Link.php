...
/** Zend_Pdf_Annotation */
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Pdf/Annotation.php';
...
class Zend_Pdf_Annotation_Link extends Zend_Pdf_Annotation
{
    ...
    public function getDestination()
    {
        ...
        if ($this->_annotationDictionary->Dest !== null) {
            require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Pdf/Destination.php';
            return Zend_Pdf_Destination::load($this->_annotationDictionary->Dest);
        } else {
            require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Pdf/Action.php';
