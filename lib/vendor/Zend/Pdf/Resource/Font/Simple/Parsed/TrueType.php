...
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Pdf/Resource/Font/FontDescriptor.php';


/** Zend_Pdf_Resource_Font_Simple_Parsed */
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Pdf/Resource/Font/Simple/Parsed.php';
