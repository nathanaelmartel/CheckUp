    ...
    static public function getInstanceByURI($uri)
    {
        switch($uri) {
            case self::ENC_AES256CBC:
                include_once sfConfig::get('sf_lib_dir').'/vendor/Zend/InfoCard/Cipher/Symmetric/Adapter/Aes256cbc.php';
                return new Zend_InfoCard_Cipher_Symmetric_Adapter_Aes256cbc();

            case self::ENC_AES128CBC:
                include_once sfConfig::get('sf_lib_dir').'/vendor/Zend/InfoCard/Cipher/Symmetric/Adapter/Aes128cbc.php';
                return new Zend_InfoCard_Cipher_Symmetric_Adapter_Aes128cbc();

            case self::ENC_RSA_OAEP_MGF1P:
                include_once sfConfig::get('sf_lib_dir').'/vendor/Zend/InfoCard/Cipher/Pki/Adapter/Rsa.php';
            ...
            default:
                require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/InfoCard/Cipher/Exception.php';
