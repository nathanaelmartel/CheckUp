 ...
 */
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/InfoCard/Xml/Security/Transform.php';
...
class Zend_InfoCard_Xml_Security
{
    ...
    static public function validateXMLSignature($strXMLInput)
    {
        if(!extension_loaded('openssl')) {
            require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/InfoCard/Xml/Security/Exception.php';
