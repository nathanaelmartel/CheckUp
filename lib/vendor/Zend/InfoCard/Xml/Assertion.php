 ...
 */
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/InfoCard/Xml/Assertion/Interface.php';
...
final class Zend_InfoCard_Xml_Assertion
{
    ...
    static public function getInstance($xmlData)
    {
        ...
        if($xmlData instanceof Zend_InfoCard_Xml_Element) {
            ...
            require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/InfoCard/Xml/Exception.php';
        ...
        foreach($namespaces as $namespace) {
            switch($namespace) {
                case self::TYPE_SAML:
                    include_once sfConfig::get('sf_lib_dir').'/vendor/Zend/InfoCard/Xml/Assertion/Saml.php';
