 ...
 */
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/InfoCard/Xml/Security/Transform/Interface.php';
    ...
    implements Zend_InfoCard_Xml_Security_Transform_Interface
{
    ...
    public function transform($strXMLData)
    {
        ...
        require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/InfoCard/Xml/Security/Transform/Exception.php';
