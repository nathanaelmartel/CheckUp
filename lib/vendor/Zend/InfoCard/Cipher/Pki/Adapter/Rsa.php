 ...
 */
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/InfoCard/Cipher/Pki/Adapter/Abstract.php';

/**
 * Zend_InfoCard_Cipher_Pki_Rsa_Interface
 */
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/InfoCard/Cipher/Pki/Rsa/Interface.php';
