 ...
 */
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Queue/Adapter/AdapterAbstract.php';

/**
 * @see Zend_Db_Select
 */
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Db/Select.php';

/**
 * @see Zend_Db
 */
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Db.php';

/**
 * @see Zend_Queue_Adapter_Db_Queue
 */
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Queue/Adapter/Db/Queue.php';

/**
 * @see Zend_Queue_Adapter_Db_Message
 */
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Queue/Adapter/Db/Message.php';
...
class Zend_Queue_Adapter_Db extends Zend_Queue_Adapter_AdapterAbstract
{
    ...
    public function __construct($options, Zend_Queue $queue = null)
    {
        ...
        if (!is_bool($this->_options['options'][Zend_Db_Select::FOR_UPDATE])) {
            require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Queue/Exception.php';
