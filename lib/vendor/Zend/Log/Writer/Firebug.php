...
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Log/Writer/Abstract.php';

/** Zend_Log_Formatter_Firebug */
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Log/Formatter/Firebug.php';

/** Zend_Wildfire_Plugin_FirePhp */
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Wildfire/Plugin/FirePhp.php';
