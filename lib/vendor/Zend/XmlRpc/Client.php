 ...
 */
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/XmlRpc/Client/ServerProxy.php';

/**
 * Introspects remote servers using the XML-RPC de facto system.* methods
 * @see Zend_XmlRpc_Client_ServerIntrospection
 */
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/XmlRpc/Client/ServerIntrospection.php';
 ...
 */
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/XmlRpc/Fault.php';
   ...
   /**
    ...
    public function doRequest($request, $response = null)
    {
        ...
        if (! $httpResponse->isSuccessful()) {
             ...
             */
            require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/XmlRpc/Client/HttpException.php';
    ...
    public function call($method, $params=array())
    {
        ...
        if ($this->_lastResponse->isFault()) {
             ...
             */
            require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/XmlRpc/Client/FaultException.php';
