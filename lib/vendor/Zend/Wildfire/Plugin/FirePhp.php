 ...
 * @version    $Id: FirePhp.php 20096 2010-01-06 02:05:09Z bkarwin $
 */
...
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Wildfire/Channel/HttpHeaders.php';
...
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Wildfire/Plugin/Interface.php';
