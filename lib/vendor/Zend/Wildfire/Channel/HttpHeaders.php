...
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Wildfire/Channel/Interface.php';

/** Zend_Controller_Request_Abstract */
require_once(sfConfig::get('sf_lib_dir').'/vendor/Zend/Controller/Request/Abstract.php');

/** Zend_Controller_Response_Abstract */
require_once(sfConfig::get('sf_lib_dir').'/vendor/Zend/Controller/Response/Abstract.php');

/** Zend_Controller_Plugin_Abstract */
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Controller/Plugin/Abstract.php';

/** Zend_Wildfire_Protocol_JsonStream */
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Wildfire/Protocol/JsonStream.php';
...
class Zend_Wildfire_Channel_HttpHeaders extends Zend_Controller_Plugin_Abstract implements Zend_Wildfire_Channel_Interface
{
    ...
    public static function init($class = null)
    {
        if (self::$_instance !== null) {
            require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Wildfire/Exception.php';
