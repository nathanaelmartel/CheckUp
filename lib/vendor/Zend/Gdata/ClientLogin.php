 ...
 */
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Gdata/HttpClient.php';
        ...
        $accountType = 'HOSTED_OR_GOOGLE')
    {
        ...
        if ($response->getStatus() == 200) {
            ...
            if (array_key_exists('Error', $goog_resp) &&
                ...
                require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Gdata/App/CaptchaRequiredException.php';
