 ...
 */
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Gdata/Calendar/EventFeed.php';

/**
 * @see Zend_Gdata_Calendar_EventEntry
 */
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Gdata/Calendar/EventEntry.php';

/**
 * @see Zend_Gdata_Calendar_ListFeed
 */
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Gdata/Calendar/ListFeed.php';

/**
 * @see Zend_Gdata_Calendar_ListEntry
 */
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Gdata/Calendar/ListEntry.php';
