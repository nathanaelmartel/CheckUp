 ...
 */
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Gdata/Kind/EventEntry.php';

/**
 * @see Zend_Gdata_Calendar_Extension_SendEventNotifications
 */
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Gdata/Calendar/Extension/SendEventNotifications.php';

/**
 * @see Zend_Gdata_Calendar_Extension_Timezone
 */
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Gdata/Calendar/Extension/Timezone.php';

/**
 * @see Zend_Gdata_Calendar_Extension_Link
 */
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Gdata/Calendar/Extension/Link.php';

/**
 * @see Zend_Gdata_Calendar_Extension_QuickAdd
 */
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Gdata/Calendar/Extension/QuickAdd.php';
