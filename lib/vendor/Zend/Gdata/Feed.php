 ...
 */
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Gdata/Extension/OpenSearchTotalResults.php';

/**
 * @see Zend_Gdata_Extension_OpenSearchStartIndex
 */
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Gdata/Extension/OpenSearchStartIndex.php';

/**
 * @see Zend_Gdata_Extension_OpenSearchItemsPerPage
 */
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Gdata/Extension/OpenSearchItemsPerPage.php';
