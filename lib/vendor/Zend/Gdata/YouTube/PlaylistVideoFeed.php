 ...
 */
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Gdata/Media/Feed.php';

/**
 * @see Zend_Gdata_YouTube_PlaylistVideoEntry
 */
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Gdata/YouTube/PlaylistVideoEntry.php';
