 ...
 */
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Gdata/YouTube/Extension/PlaylistTitle.php';

/**
 * @see Zend_Gdata_YouTube_Extension_PlaylistId
 */
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Gdata/YouTube/Extension/PlaylistId.php';
 ...
 */
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Gdata/YouTube/Extension/CountHint.php';

/**
 * @see Zend_Gdata_YouTube_Extension_QueryString
 */
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Gdata/YouTube/Extension/QueryString.php';
