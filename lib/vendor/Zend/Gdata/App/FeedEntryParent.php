...
*/
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Gdata/App/Extension/Element.php';

/**
 * @see Zend_Gdata_App_Extension_Author
*/
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Gdata/App/Extension/Author.php';
...
*/
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Gdata/App/Extension/Contributor.php';

/**
 * @see Zend_Gdata_App_Extension_Id
 */
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Gdata/App/Extension/Id.php';

/**
 * @see Zend_Gdata_App_Extension_Link
 */
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Gdata/App/Extension/Link.php';

/**
 * @see Zend_Gdata_App_Extension_Rights
 */
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Gdata/App/Extension/Rights.php';

/**
 * @see Zend_Gdata_App_Extension_Title
 */
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Gdata/App/Extension/Title.php';

/**
 * @see Zend_Gdata_App_Extension_Updated
 */
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Gdata/App/Extension/Updated.php';

/**
 * Zend_Version
 */
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Version.php';
