 ...
 */
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Gdata/DublinCore.php';

/**
 * @see Zend_Gdata_Books_CollectionEntry
 */
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Gdata/Books/CollectionEntry.php';

/**
 * @see Zend_Gdata_Books_CollectionFeed
 */
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Gdata/Books/CollectionFeed.php';

/**
 * @see Zend_Gdata_Books_VolumeEntry
 */
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Gdata/Books/VolumeEntry.php';

/**
 * @see Zend_Gdata_Books_VolumeFeed
 */
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Gdata/Books/VolumeFeed.php';
