 ...
 */
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Gdata/Gapps.php';

/**
 * @see Zend_Gdata_Photos_Extension_Nickname
 */
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Gdata/Photos/Extension/Nickname.php';

/**
 * @see Zend_Gdata_Photos_Extension_Thumbnail
 */
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Gdata/Photos/Extension/Thumbnail.php';

/**
 * @see Zend_Gdata_Photos_Extension_QuotaCurrent
 */
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Gdata/Photos/Extension/QuotaCurrent.php';

/**
 * @see Zend_Gdata_Photos_Extension_QuotaLimit
 */
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Gdata/Photos/Extension/QuotaLimit.php';

/**
 * @see Zend_Gdata_Photos_Extension_MaxPhotosPerAlbum
 */
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Gdata/Photos/Extension/MaxPhotosPerAlbum.php';

/**
 * @see Zend_Gdata_Photos_Extension_User
 */
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Gdata/Photos/Extension/User.php';
