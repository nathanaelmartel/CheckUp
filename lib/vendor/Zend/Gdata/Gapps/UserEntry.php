 ...
 */
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Gdata/Gapps/Extension/Login.php';

/**
 * @see Zend_Gdata_Gapps_Extension_Name
 */
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Gdata/Gapps/Extension/Name.php';

/**
 * @see Zend_Gdata_Gapps_Extension_Quota
 */
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Gdata/Gapps/Extension/Quota.php';
