 ...
 */
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Gdata/Media.php';

/**
 * @see Zend_Gdata_YouTube_VideoEntry
 */
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Gdata/YouTube/VideoEntry.php';

/**
 * @see Zend_Gdata_YouTube_VideoFeed
 */
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Gdata/YouTube/VideoFeed.php';

/**
 * @see Zend_Gdata_YouTube_CommentFeed
 */
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Gdata/YouTube/CommentFeed.php';

/**
 * @see Zend_Gdata_YouTube_PlaylistListFeed
 */
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Gdata/YouTube/PlaylistListFeed.php';

/**
 * @see Zend_Gdata_YouTube_SubscriptionFeed
 */
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Gdata/YouTube/SubscriptionFeed.php';

/**
 * @see Zend_Gdata_YouTube_ContactFeed
 */
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Gdata/YouTube/ContactFeed.php';

/**
 * @see Zend_Gdata_YouTube_PlaylistVideoFeed
 */
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Gdata/YouTube/PlaylistVideoFeed.php';

/**
 * @see Zend_Gdata_YouTube_ActivityFeed
 */
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Gdata/YouTube/ActivityFeed.php';

/**
 * @see Zend_Gdata_YouTube_InboxFeed
 */
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Gdata/YouTube/InboxFeed.php';
...
class Zend_Gdata_YouTube extends Zend_Gdata_Media
{
        ...
        $developerKey = null)
    {
        ...
        if (!$client instanceof Zend_Http_Client) {
            require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Gdata/App/HttpException.php';
