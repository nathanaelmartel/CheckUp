 ...
 * Zend_Gdata_Feed
 */
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Gdata/App/Feed.php';
 ...
 */
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Gdata/App/MediaSource.php';
...
class Zend_Gdata_App
{
    ...
    {
        require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Http/Client/Exception.php';
        ...
        if ($body instanceof Zend_Gdata_MediaMimeStream) {
            ...
            if ($oldHttpAdapter instanceof Zend_Http_Client_Adapter_Proxy) {
                require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Gdata/HttpAdapterStreamingProxy.php';
                $newAdapter = new Zend_Gdata_HttpAdapterStreamingProxy();
            } else {
                require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Gdata/HttpAdapterStreamingSocket.php';
