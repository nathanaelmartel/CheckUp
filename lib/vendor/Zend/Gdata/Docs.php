 ...
 */
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Gdata/Docs/DocumentListFeed.php';

/**
 * @see Zend_Gdata_Docs_DocumentListEntry
 */
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Gdata/Docs/DocumentListEntry.php';
