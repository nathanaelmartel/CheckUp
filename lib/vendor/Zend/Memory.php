...
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Memory/Manager.php';

/** Zend_Memory_Value */
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Memory/Value.php';

/** Zend_Memory_Container */
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Memory/Container.php';
...
class Zend_Memory
{
    ...
    public static function factory($backend, $backendOptions = array())
    {
        ...
        if (!$backendIsFound) {
            require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Memory/Exception.php';
