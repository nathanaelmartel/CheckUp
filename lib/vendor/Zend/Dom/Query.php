 ...
 */
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Dom/Query/Css2Xpath.php';

/**
 * @see Zend_Dom_Query_Result
 */
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Dom/Query/Result.php';
...
class Zend_Dom_Query
{
    ...
    public function queryXpath($xpathQuery, $query = null)
    {
        if (null === ($document = $this->getDocument())) {
            require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Dom/Exception.php';
