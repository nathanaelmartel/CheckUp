 ...
 */
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Tool/Framework/Manifest/MetadataManifestable.php';
 ...
 */
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Filter/Word/CamelCaseToDash.php';

/**
 * @see Zend_Filter_StringToLower
 */
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Filter/StringToLower.php';

/**
 * @see Zend_Tool_Framework_Metadata_Tool
 */
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Tool/Framework/Metadata/Tool.php';

/**
 * @see Zend_Tool_Framework_Registry_EnabledInterface
 */
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Tool/Framework/Registry/EnabledInterface.php';
