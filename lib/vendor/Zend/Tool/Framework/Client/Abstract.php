...
abstract class Zend_Tool_Framework_Client_Abstract implements Zend_Tool_Framework_Registry_EnabledInterface
{
    ...
    public function initialize()
    {
        ...
        if (!$this->_debugLogger instanceof Zend_Log) {
            require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Log.php';
            require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Log/Writer/Null.php';
        ...
        if ($this instanceof Zend_Tool_Framework_Client_Interactive_InputInterface) {
            require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Tool/Framework/Client/Interactive/InputHandler.php';
        }
    ...
    public function promptInteractiveInput($inputRequest)
    {
        if (!$this->hasInteractiveInput()) {
            require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Tool/Framework/Client/Exception.php';
