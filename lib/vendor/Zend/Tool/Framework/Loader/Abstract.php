...
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Tool/Framework/Loader/Interface.php';
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Tool/Framework/Manifest/Interface.php';
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Tool/Framework/Provider/Interface.php';
