 ...
 */
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Reflection/Class.php';
 ...
 */
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Tool/Framework/Action/Base.php';
    ...
    protected function _processSpecialties()
    {
        ...
        if ($this->_providerReflection->hasMethod('getSpecialties')) {
            ...
            if (!is_array($specialties)) {
                require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Tool/Framework/Provider/Exception.php';
