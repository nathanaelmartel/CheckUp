 ...
 */
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Tool/Framework/Metadata/Interface.php';

/**
 * @see Zend_Tool_Framework_Metadata_Attributable
 */
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Tool/Framework/Metadata/Attributable.php';
