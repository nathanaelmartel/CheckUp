...
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Tool/Project/Profile/FileParser/Interface.php';
...
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Tool/Project/Profile/Resource.php';
