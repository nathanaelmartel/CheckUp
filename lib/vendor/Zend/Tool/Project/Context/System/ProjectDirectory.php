 ...
 */
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Tool/Project/Context/Filesystem/Directory.php';

/**
 * @see Zend_Tool_Project_Context_System_Interface
 */
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Tool/Project/Context/System/Interface.php';

/**
 * @see Zend_Tool_Project_Context_System_TopLevelRestrictable
 */
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Tool/Project/Context/System/TopLevelRestrictable.php';

/**
 * @see Zend_Tool_Project_Context_System_NotOverwritable
 */
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Tool/Project/Context/System/NotOverwritable.php';
               ...
               Zend_Tool_Project_Context_System_TopLevelRestrictable
{
    ...
    public function init()
    {
        ...
        // if not, exception.
        if ($projectDirectory == null) {
            require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Tool/Project/Exception.php';
            ...
            foreach (new DirectoryIterator($this->getPath()) as $item) {
                if (!$item->isDot()) {
                    if ($registry->getClient()->isInteractive()) {
                        ...
                        require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Tool/Project/Context/Exception.php';
