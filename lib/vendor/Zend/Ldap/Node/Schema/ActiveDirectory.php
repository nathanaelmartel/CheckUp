 ...
 */
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Ldap/Node/Schema/AttributeType/ActiveDirectory.php';
/**
 * @see Zend_Ldap_Node_Schema_ObjectClass_ActiveDirectory
 */
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Ldap/Node/Schema/ObjectClass/ActiveDirectory.php';
