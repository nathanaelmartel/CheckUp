...
class Zend_Service_Flickr
{
    ...
    public function tagSearch($query, array $options = array())
    {
         ...
         */
        require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Service/Flickr/ResultSet.php';
    ...
    public function getImageDetails($id)
    {
         ...
         */
        require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Service/Flickr/Image.php';
    ...
    protected function _validateUserSearch(array $options)
    {
         ...
         */
        require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Validate/Int.php';
