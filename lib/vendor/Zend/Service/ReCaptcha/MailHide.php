...
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Service/ReCaptcha.php';
...
class Zend_Service_ReCaptcha_MailHide extends Zend_Service_ReCaptcha
{
    ...
    protected function _requireMcrypt()
    {
        if (!extension_loaded('mcrypt')) {
            ...
            require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Service/ReCaptcha/MailHide/Exception.php';
