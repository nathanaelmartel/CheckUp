 ...
 */
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Service/WindowsAzure/Credentials/CredentialsAbstract.php';

/**
 * @see Zend_Service_WindowsAzure_Credentials_SharedKey
 */
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Service/WindowsAzure/Credentials/SharedKey.php';

/**
 * @see Zend_Service_WindowsAzure_Credentials_SharedKeyLite
 */
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Service/WindowsAzure/Credentials/SharedKeyLite.php';

/**
 * @see Zend_Service_WindowsAzure_RetryPolicy_RetryPolicyAbstract
 */
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Service/WindowsAzure/RetryPolicy/RetryPolicyAbstract.php';

/**
 * @see Zend_Http_Client
 */
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Http/Client.php';

/**
 * @see Zend_Http_Response
 */
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Http/Response.php';

/**
 * @see Zend_Service_WindowsAzure_Storage
 */
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Service/WindowsAzure/Storage.php';

/**
 * @see Zend_Service_WindowsAzure_Storage_BatchStorageAbstract
 */
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Service/WindowsAzure/Storage/BatchStorageAbstract.php';

/**
 * @see Zend_Service_WindowsAzure_Storage_TableInstance
 */
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Service/WindowsAzure/Storage/TableInstance.php';

/**
 * @see Zend_Service_WindowsAzure_Storage_TableEntity
 */
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Service/WindowsAzure/Storage/TableEntity.php';

/**
 * @see Zend_Service_WindowsAzure_Storage_DynamicTableEntity
 */
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Service/WindowsAzure/Storage/DynamicTableEntity.php';

/**
 * @see Zend_Service_WindowsAzure_Storage_TableEntityQuery
 */
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Service/WindowsAzure/Storage/TableEntityQuery.php';

/**
 * @see Zend_Service_WindowsAzure_Exception
 */
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Service/WindowsAzure/Exception.php';
