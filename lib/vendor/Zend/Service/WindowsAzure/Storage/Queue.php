 ...
 */
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Service/WindowsAzure/Storage/QueueInstance.php';

/**
 * Zend_Service_WindowsAzure_Storage_QueueMessage
 */
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Service/WindowsAzure/Storage/QueueMessage.php';
