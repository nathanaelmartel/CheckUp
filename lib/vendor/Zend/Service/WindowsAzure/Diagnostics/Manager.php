 ...
 */
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Service/WindowsAzure/Storage/Blob.php';
 ...
 */
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Service/WindowsAzure/Diagnostics/ConfigurationInstance.php';
