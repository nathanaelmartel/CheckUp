 ...
 */
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Service/WindowsAzure/Diagnostics/Exception.php';

/**
 * @see Zend_Service_WindowsAzure_Diagnostics_ConfigurationObjectBaseAbstract
 */
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Service/WindowsAzure/Diagnostics/ConfigurationObjectBaseAbstract.php';

/**
 * @see Zend_Service_WindowsAzure_Diagnostics_ConfigurationLogs
 */
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Service/WindowsAzure/Diagnostics/ConfigurationLogs.php';

/**
 * @see Zend_Service_WindowsAzure_Diagnostics_ConfigurationDiagnosticInfrastructureLogs
 */
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Service/WindowsAzure/Diagnostics/ConfigurationDiagnosticInfrastructureLogs.php';

/**
 * @see Zend_Service_WindowsAzure_Diagnostics_ConfigurationPerformanceCounters
 */
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Service/WindowsAzure/Diagnostics/ConfigurationPerformanceCounters.php';

/**
 * @see Zend_Service_WindowsAzure_Diagnostics_ConfigurationWindowsEventLog
 */
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Service/WindowsAzure/Diagnostics/ConfigurationWindowsEventLog.php';

/**
 * @see Zend_Service_WindowsAzure_Diagnostics_ConfigurationDirectories
 */
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Service/WindowsAzure/Diagnostics/ConfigurationDirectories.php';
