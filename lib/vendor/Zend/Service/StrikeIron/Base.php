 ...
 */
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Service/StrikeIron/Decorator.php';
...
class Zend_Service_StrikeIron_Base
{
    ...
    public function __construct($options = array())
    {
        if (!extension_loaded('soap')) {
             ...
             */
            require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Service/StrikeIron/Exception.php';
