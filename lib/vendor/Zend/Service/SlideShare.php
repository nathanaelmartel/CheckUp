 ...
 * Zend_Cache
 */
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Cache.php';

/**
 * Zend_Service_SlideShare_SlideShow
 */
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Service/SlideShare/SlideShow.php';
...
class Zend_Service_SlideShare
{
    ...
    public function uploadSlideShow(Zend_Service_SlideShare_SlideShow $ss, $make_src_public = true)
    {
        ...
        if(!file_exists($filename) || !is_readable($filename)) {
            require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Service/SlideShare/Exception.php';
