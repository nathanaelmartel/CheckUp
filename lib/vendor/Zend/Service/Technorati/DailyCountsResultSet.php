 ...
 */
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Service/Technorati/ResultSet.php';

/**
 * @see Zend_Service_Technorati_Utils
 */
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Service/Technorati/Utils.php';
...
class Zend_Service_Technorati_DailyCountsResultSet extends Zend_Service_Technorati_ResultSet
{
    ...
    public function current()
    {
         ...
         */
        require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Service/Technorati/DailyCountsResult.php';
