 ...
 */
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Rest/Client/Result.php';

/**
 * @see Zend_Oauth_Consumer
 */
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Oauth/Consumer.php';
...
class Zend_Service_Twitter extends Zend_Rest_Client
{
    ...
    public function __get($type)
    {
        if (!in_array($type, $this->_methodTypes)) {
            include_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Service/Twitter/Exception.php';
    ...
    protected function _init()
    {
        if (!$this->isAuthorised() && $this->getUsername() !== null) {
            require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Service/Twitter/Exception.php';
            throw new Zend_Service_Twitter_Exception(
    ...
    protected function _prepare($path)
    {
        ...
        if (!$this->_uri instanceof Zend_Uri_Http) {
            require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Rest/Client/Exception.php';
