 ...
 */
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Session/Abstract.php';

/**
 * @see Zend_Session_Namespace
 */
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Session/Namespace.php';

/**
 * @see Zend_Session_SaveHandler_Interface
 */
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Session/SaveHandler/Interface.php';
    ...
    public static function setOptions(array $userOptions = array())
    {
        ...
        foreach ($userOptions as $userOptionName => $userOptionValue) {
            ...
            elseif (isset(self::$_localOptions[$userOptionName])) {
                ...
                require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Session/Exception.php';
