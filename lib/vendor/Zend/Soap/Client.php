 ...
 */
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Soap/Server.php';

/**
 * @see Zend_Soap_Client_Local
 */
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Soap/Client/Local.php';

/**
 * @see Zend_Soap_Client_Common
 */
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Soap/Client/Common.php';
...
class Zend_Soap_Client
{
    ...
    public function __construct($wsdl = null, $options = null)
    {
        if (!extension_loaded('soap')) {
            require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Soap/Client/Exception.php';
