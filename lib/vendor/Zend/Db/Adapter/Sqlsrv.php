 ...
 */
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Db/Statement/Sqlsrv.php';
...
class Zend_Db_Adapter_Sqlsrv extends Zend_Db_Adapter_Abstract
{
    ...
    protected function _connect()
    {
        ...
        if (!extension_loaded('sqlsrv')) {
             ...
             */
            require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Db/Adapter/Sqlsrv/Exception.php';
