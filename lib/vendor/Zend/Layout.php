...
class Zend_Layout
{
    ...
    public function __construct($options = null, $initMvc = false)
    {
        if (null !== $options) {
            if (is_string($options)) {
                ...
                require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Layout/Exception.php';
    ...
    protected function _initVarContainer()
    {
        if (null === $this->_container) {
            require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/View/Helper/Placeholder/Registry.php';
