...
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Form/Element/Xhtml.php';
    ...
    public function getPluginLoader($type)
    {
        ...
        if (!array_key_exists($type, $this->_loaders)) {
            ...
            $loader = new Zend_Loader_PluginLoader(array(
                'Zend_File_Transfer_Adapter' => sfConfig::get('sf_lib_dir').'/vendor/Zend/File/Transfer/Adapter/',
            ));
