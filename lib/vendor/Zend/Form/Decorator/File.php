...
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Form/Decorator/Marker/File/Interface.php';

/** Zend_File_Transfer_Adapter_Http */
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/File/Transfer/Adapter/Http.php';
