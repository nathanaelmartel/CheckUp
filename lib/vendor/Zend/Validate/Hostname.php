 ...
 */
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Validate/Abstract.php';

/**
 * @see Zend_Validate_Ip
 */
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Validate/Ip.php';
...
class Zend_Validate_Hostname extends Zend_Validate_Abstract
{
    ...
    protected $_validIdns = array(
        ...
        'CN'  => 'Hostname/Cn.php',
        //'COM' => sfConfig::get('sf_lib_dir').'/vendor/Zend/Validate/Hostname/Com.php',
        ...
        //'HK'  => sfConfig::get('sf_lib_dir').'/vendor/Zend/Validate/Hostname/Cn.php',
        ...
        //'JP'  => sfConfig::get('sf_lib_dir').'/vendor/Zend/Validate/Hostname/Jp.php',
        ...
        //'NET' => sfConfig::get('sf_lib_dir').'/vendor/Zend/Validate/Hostname/Com.php',
        'NO'  => array(1 => '/^[\x{002d}0-9a-zàáä-éêñ-ôöøüčđńŋšŧž]{1,63}$/iu'),
        //'NU'  => sfConfig::get('sf_lib_dir').'/vendor/Zend/Validate/Hostname/Com.php',
        ...
        //'TW'  => sfConfig::get('sf_lib_dir').'/vendor/Zend/Validate/Hostname/Cn.php',
        ...
        //'中国' => sfConfig::get('sf_lib_dir').'/vendor/Zend/Validate/Hostname/Cn.php',
        //'公司' => sfConfig::get('sf_lib_dir').'/vendor/Zend/Validate/Hostname/Cn.php',
        //'网络' => sfConfig::get('sf_lib_dir').'/vendor/Zend/Validate/Hostname/Cn.php'
    );
