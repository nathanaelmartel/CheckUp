 ...
 */
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Date/DateObject.php';
...
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Locale/Math.php';
                ...
                switch($name) {
                    case 'format_type' :
                        if ((strtolower($value) != 'php') && (strtolower($value) != 'iso')) {
                            require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Date/Exception.php';
