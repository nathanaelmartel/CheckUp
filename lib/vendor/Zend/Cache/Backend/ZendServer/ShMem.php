...
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Cache/Backend/Interface.php';

/** @see Zend_Cache_Backend_ZendServer */
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Cache/Backend/ZendServer.php';
