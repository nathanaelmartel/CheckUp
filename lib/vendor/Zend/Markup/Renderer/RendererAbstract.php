 ...
 */
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Markup/Renderer/TokenConverterInterface.php';
...
abstract class Zend_Markup_Renderer_RendererAbstract
{
    ...
    public function addMarkup($name, $type, array $options)
    {
        if (!isset($options['group']) && ($type ^ self::TYPE_ALIAS)) {
            require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Markup/Renderer/Exception.php';
