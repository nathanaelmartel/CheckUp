 ...
 */
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Filter/HtmlEntities.php';
/**
 ...
 */
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Filter/Callback.php';
/**
 * @see Zend_Markup_Renderer_RendererAbstract
 */
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Markup/Renderer/RendererAbstract.php';
...
class Zend_Markup_Renderer_Html extends Zend_Markup_Renderer_RendererAbstract
{
    ...
    public function __construct($options = array())
    {
        ...
        $this->_pluginLoader = new Zend_Loader_PluginLoader(array(
            'Zend_Markup_Renderer_Html' => sfConfig::get('sf_lib_dir').'/vendor/Zend/Markup/Renderer/Html/'
        ));
