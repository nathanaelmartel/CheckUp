 ...
 */
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Controller/Router/Route/Interface.php';

/**
 * @see Zend_Controller_Router_Route_Module
 */
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Controller/Router/Route/Module.php';

/**
 * @see Zend_Controller_Dispatcher_Interface
 */
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Controller/Dispatcher/Interface.php';
