...
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Controller/Front.php';

/** @see Zend_Controller_Action_HelperBroker */
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Controller/Action/HelperBroker.php';

/** @see Zend_Layout */
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Layout.php';

/** @see Zend_Session */
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Session.php';

/** @see Zend_Registry */
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Registry.php';
...
abstract class Zend_Test_PHPUnit_ControllerTestCase extends PHPUnit_Framework_TestCase
{
    ...
    public function __set($name, $value)
    {
        if (in_array($name, array('request', 'response', 'frontController'))) {
            require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Exception.php';
    ...
    public function assertQuery($path, $message = '')
    {
        ...
        require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Test/PHPUnit/Constraint/DomQuery.php';
    ...
    {
        $this->_incrementAssertionCount();
        require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Test/PHPUnit/Constraint/Redirect.php';
    ...
    {
        $this->_incrementAssertionCount();
        require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Test/PHPUnit/Constraint/ResponseHeader.php';
    ...
    public function getRequest()
    {
        if (null === $this->_request) {
            require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Controller/Request/HttpTestCase.php';
    ...
    public function getResponse()
    {
        if (null === $this->_response) {
            require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Controller/Response/HttpTestCase.php';
    ...
    {
        if (null === $this->_query) {
            require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Dom/Query.php';
