 ...
 */
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Tag/Cloud/Decorator/Tag.php';
    ...
    public function setClassList(array $classList = null)
    {
        if (is_array($classList)) {
            if (count($classList) === 0) {
                require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Tag/Cloud/Decorator/Exception.php';
