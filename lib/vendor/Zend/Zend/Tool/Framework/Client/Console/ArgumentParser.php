 ...
 */
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Console/Getopt.php';
...
class Zend_Tool_Framework_Client_Console_ArgumentParser implements Zend_Tool_Framework_Registry_EnabledInterface
{
    ...
    {
        require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Tool/Framework/Client/Console/HelpSystem.php';
