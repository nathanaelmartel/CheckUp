 ...
 */
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Tool/Framework/Loader/Abstract.php';

/**
 * @see Zend_Tool_Framework_Loader_IncludePathLoader_RecursiveFilterIterator
 */
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Tool/Framework/Loader/IncludePathLoader/RecursiveFilterIterator.php';
