 ...
 */
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Tool/Project/Provider/Abstract.php';

/**
 * @see Zend_Tool_Framework_Provider_Pretendable
 */
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Tool/Framework/Provider/Pretendable.php';

/**
 * @see Zend_Tool_Project_Profile_Iterator_ContextFilter
 */
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Tool/Project/Profile/Iterator/ContextFilter.php';

/**
 * @see Zend_Tool_Project_Profile_Iterator_EnabledResourceFilter
 */
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Tool/Project/Profile/Iterator/EnabledResourceFilter.php';
