 ...
 */
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Tool/Project/Profile.php';

/**
 * @see Zend_Tool_Framework_Provider_Abstract
 */
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Tool/Framework/Provider/Abstract.php';

/**
 * @see Zend_Tool_Project_Context_Repository
 */
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Tool/Project/Context/Repository.php';

/**
 * @see Zend_Tool_Project_Profile_FileParser_Xml
 */
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Tool/Project/Profile/FileParser/Xml.php';

/**
 * @see Zend_Tool_Framework_Registry
 */
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Tool/Framework/Registry.php';
...
abstract class Zend_Tool_Project_Provider_Abstract extends Zend_Tool_Framework_Provider_Abstract
{
    ...
    protected function _loadProfileRequired()
    {
        ...
        if ($profile === false) {
            require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Tool/Project/Provider/Exception.php';
    ...
    protected function _getContentForContext(Zend_Tool_Project_Context_Interface $context, $methodName, $parameters)
    {
        ...
        if (!class_exists('Zend_Tool_Project_Context_Content_Engine')) {
            require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Tool/Project/Context/Content/Engine.php';
        }
