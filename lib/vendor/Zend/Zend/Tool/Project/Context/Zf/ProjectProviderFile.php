 ...
 */
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/CodeGenerator/Php/File.php';
...
class Zend_Tool_Project_Context_Zf_ProjectProviderFile extends Zend_Tool_Project_Context_Filesystem_File
{
    ...
    public function getContents()
    {
        ...
        $codeGenFile = new Zend_CodeGenerator_Php_File(array(
            'requiredFiles' => array(
                sfConfig::get('sf_lib_dir').'/vendor/Zend/Tool/Project/Provider/Abstract.php',
                sfConfig::get('sf_lib_dir').'/vendor/Zend/Tool/Project/Provider/Exception.php'
                ),
            'classes' => array($class)
            ));
