 ...
 */
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Gdata/Gbase/ItemFeed.php';

/**
 * @see Zend_Gdata_Gbase_ItemEntry
 */
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Gdata/Gbase/ItemEntry.php';

/**
 * @see Zend_Gdata_Gbase_SnippetEntry
 */
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Gdata/Gbase/SnippetEntry.php';

/**
 * @see Zend_Gdata_Gbase_SnippetFeed
 */
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Gdata/Gbase/SnippetFeed.php';
