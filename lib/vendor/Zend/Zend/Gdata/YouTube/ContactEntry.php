 ...
 */
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Gdata/YouTube/UserProfileEntry.php';

/**
 * @see Zend_Gdata_YouTube_Extension_Status
 */
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Gdata/YouTube/Extension/Status.php';
