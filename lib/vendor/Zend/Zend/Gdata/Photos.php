 ...
 */
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Gdata/Photos/UserFeed.php';

/**
 * @see Zend_Gdata_Photos_AlbumFeed
 */
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Gdata/Photos/AlbumFeed.php';

/**
 * @see Zend_Gdata_Photos_PhotoFeed
 */
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Gdata/Photos/PhotoFeed.php';
