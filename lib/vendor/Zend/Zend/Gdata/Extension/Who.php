 ...
 */
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Gdata/Extension/AttendeeStatus.php';

/**
 * @see Zend_Gdata_Extension_AttendeeType
 */
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Gdata/Extension/AttendeeType.php';
