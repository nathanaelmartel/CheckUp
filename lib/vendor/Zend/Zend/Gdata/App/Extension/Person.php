 ...
 */
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Gdata/App/Extension/Name.php';

/**
 * @see Zend_Gdata_App_Extension_Email
 */
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Gdata/App/Extension/Email.php';

/**
 * @see Zend_Gdata_App_Extension_Uri
 */
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Gdata/App/Extension/Uri.php';
