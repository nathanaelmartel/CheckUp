 ...
 */
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Db/Profiler.php';
 ...
 */
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Db/Statement/Mysqli.php';
...
class Zend_Db_Adapter_Mysqli extends Zend_Db_Adapter_Abstract
{
    ...
    public function listTables()
    {
        ...
        if ($queryResult = $this->getConnection()->query($sql)) {
             ...
             */
            require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Db/Adapter/Mysqli/Exception.php';
