 ...
 */
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Db/Statement/Oracle.php';
...
class Zend_Db_Adapter_Oracle extends Zend_Db_Adapter_Abstract
{
    ...
    protected function _connect()
    {
        ...
        if (!extension_loaded('oci8')) {
             ...
             */
            require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Db/Adapter/Oracle/Exception.php';
