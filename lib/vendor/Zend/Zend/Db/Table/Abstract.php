 ...
 */
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Db/Adapter/Abstract.php';
...
abstract class Zend_Db_Table_Abstract
{
    ...
    protected static function _setupAdapter($db)
    {
        ...
        if (!$db instanceof Zend_Db_Adapter_Abstract) {
            require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Db/Table/Exception.php';
    ...
    {
        require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Db/Table/Select.php';
