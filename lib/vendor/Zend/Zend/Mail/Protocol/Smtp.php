 ...
 */
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Mail/Protocol/Abstract.php';
        ...
        if (isset($config['ssl'])) {
            switch (strtolower($config['ssl'])) {
                ...
                default:
                     ...
                     */
                    require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Mail/Protocol/Exception.php';
