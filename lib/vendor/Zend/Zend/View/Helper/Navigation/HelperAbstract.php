 ...
 */
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/View/Helper/Navigation/Helper.php';

/**
 * @see Zend_View_Helper_HtmlElement
 */
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/View/Helper/HtmlElement.php';
    ...
    implements Zend_View_Helper_Navigation_Helper
{
    ...
    public function getContainer()
    {
        if (null === $this->_container) {
            ...
            require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Navigation.php';
