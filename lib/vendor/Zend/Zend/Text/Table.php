...
class Zend_Text_Table
{
    ...
    public function __construct($options = null)
    {
        ...
        if ($this->_columnWidths === null) {
            require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Text/Table/Exception.php';
    ...
    public function getPluginLoader()
    {
        if ($this->_pluginLoader === null) {
            ...
            $pathPrefix = sfConfig::get('sf_lib_dir').'/vendor/Zend/Text/Table/Decorator/';
    ...
    public function appendRow($row)
    {
        ...
        if (is_array($row)) {
            ...
            require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Text/Table/Row.php';
