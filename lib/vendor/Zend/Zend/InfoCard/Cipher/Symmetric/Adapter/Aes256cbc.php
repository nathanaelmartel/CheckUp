 ...
 */
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/InfoCard/Cipher/Symmetric/Adapter/Abstract.php';

/**
 * Zend_InfoCard_Cipher_Symmetric_Aes256cbc_Interface
 */
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/InfoCard/Cipher/Symmetric/Aes256cbc/Interface.php';
