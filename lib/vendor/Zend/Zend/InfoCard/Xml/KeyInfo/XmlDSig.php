 ...
 */
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/InfoCard/Xml/KeyInfo/Abstract.php';

/**
 * Zend_InfoCard_Xml_EncryptedKey
 */
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/InfoCard/Xml/EncryptedKey.php';

/**
 * Zend_InfoCard_Xml_KeyInfo_Interface
 */
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/InfoCard/Xml/KeyInfo/Interface.php';
