 ...
 */
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/InfoCard/Xml/Element.php';
...
class Zend_InfoCard_Xml_KeyInfo
{
    ...
    static public function getInstance($xmlData)
    {
            ...
            foreach($sxe->getDocNameSpaces() as $namespace) {
                switch($namespace) {
                    case 'http://www.w3.org/2000/09/xmldsig#':
                        include_once sfConfig::get('sf_lib_dir').'/vendor/Zend/InfoCard/Xml/KeyInfo/XmlDSig.php';
        ...
        include_once sfConfig::get('sf_lib_dir').'/vendor/Zend/InfoCard/Xml/KeyInfo/Default.php';
