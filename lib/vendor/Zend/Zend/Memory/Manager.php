...
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Memory/Container/Movable.php';

/** Zend_Memory_Container_Locked */
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Memory/Container/Locked.php';

/** Zend_Memory_AccessController */
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Memory/AccessController.php';
