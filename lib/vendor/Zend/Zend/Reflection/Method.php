 ...
 */
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Reflection/Docblock.php';

/**
 * @see Zend_Reflection_Parameter
 */
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Reflection/Parameter.php';
...
class Zend_Reflection_Method extends ReflectionMethod
{
    ...
    public function getDocblock($reflectionClass = 'Zend_Reflection_Docblock')
    {
        if ('' == $this->getDocComment()) {
            require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Reflection/Exception.php';
