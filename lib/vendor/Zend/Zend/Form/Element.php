...
/** @see Zend_Filter */
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Filter.php';

/** @see Zend_Form */
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Form.php';

/** @see Zend_Validate_Interface */
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Validate/Interface.php';
...
class Zend_Form_Element implements Zend_Validate_Interface
{
    ...
    public function __construct($spec, $options = null)
    {
        ...
        if (null === $this->getName()) {
            require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Form/Exception.php';
    ...
    public function __call($method, $args)
    {
        if ('render' == substr($method, 0, 6)) {
            ...
            require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Form/Element/Exception.php';
            ...
            case self::DECORATOR:
                ...
                if (!isset($this->_loaders[$type])) {
                    ...
                    $this->_loaders[$type] = new Zend_Loader_PluginLoader(
                        array('Zend_' . $prefixSegment . '_' => sfConfig::get('sf_lib_dir').'/vendor/Zend/' . $pathSegment . '/')
                    );
                }
