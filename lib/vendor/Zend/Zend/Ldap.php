...
class Zend_Ldap
{
    ...
    public static function filterEscape($str)
    {
         ...
         */
        require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Ldap/Filter/Abstract.php';
    ...
    public static function explodeDn($dn, array &$keys = null, array &$vals = null)
    {
         ...
         * @see Zend_Ldap_Dn
         */
        require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Ldap/Dn.php';
    ...
    public function __construct($options = array())
    {
        if (!extension_loaded('ldap')) {
             ...
             */
            require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Ldap/Exception.php';
        ...
        array $attributes = array(), $sort = null, $collectionClass = null)
    {
         ...
         */
        require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Ldap/Collection/Iterator/Default.php';
    ...
    protected function _createCollection(Zend_Ldap_Collection_Iterator_Default $iterator, $collectionClass)
    {
        if ($collectionClass === null) {
             ...
             */
            require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Ldap/Collection.php';
    ...
    public function getNode($dn)
    {
         ...
         * Zend_Ldap_Node
         */
        require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Ldap/Node.php';
    ...
    public function getRootDse()
    {
        if ($this->_rootDse === null) {
             ...
             */
            require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Ldap/Node/RootDse.php';
    ...
    public function getSchema()
    {
        if ($this->_schema === null) {
             ...
             * @see Zend_Ldap_Node_Schema
             */
            require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Ldap/Node/Schema.php';
