 ...
 */
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Feed/Pubsubhubbub.php';

/**
 * @see Zend_Feed_Pubsubhubbub
 */
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Feed/Pubsubhubbub/CallbackAbstract.php';
