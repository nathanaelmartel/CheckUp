 ...
 */
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Feed/Pubsubhubbub/CallbackInterface.php';

/**
 * @see Zend_Feed_Pubsubhubbub_HttpResponse
 */
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Feed/Pubsubhubbub/HttpResponse.php';
