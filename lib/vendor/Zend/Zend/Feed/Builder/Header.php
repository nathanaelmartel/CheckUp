 ...
 */
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Feed/Builder/Header/Itunes.php';
...
class Zend_Feed_Builder_Header extends ArrayObject
{
    ...
    public function setEmail($email)
    {
        ...
        if (!$validate->isValid($email)) {
             ...
             */
            require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Feed/Builder/Exception.php';
