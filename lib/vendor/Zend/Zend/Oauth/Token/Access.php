...
/** Zend_Oauth_Token */
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Oauth/Token.php';

/** Zend_Oauth_Http */
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Oauth/Http.php';

/** Zend_Uri_Http */
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Uri/Http.php';

/** Zend_Oauth_Client */
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Oauth/Client.php';
