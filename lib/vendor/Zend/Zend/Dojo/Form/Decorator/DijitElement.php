...
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Form/Decorator/ViewHelper.php';
...
class Zend_Dojo_Form_Decorator_DijitElement extends Zend_Form_Decorator_ViewHelper
{
    ...
    public function render($content)
    {
        ...
        if (null === $view) {
            require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Form/Decorator/Exception.php';
