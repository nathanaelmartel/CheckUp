...
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Form/DisplayGroup.php';
...
class Zend_Dojo_Form_DisplayGroup extends Zend_Form_DisplayGroup
{
    ...
    public function __construct($name, Zend_Loader_PluginLoader $loader, $options = null)
    {
        ...
        $this->addPrefixPath('Zend_Dojo_Form_Decorator', sfConfig::get('sf_lib_dir').'/vendor/Zend/Dojo/Form/Decorator');
    }
