 ...
 * @see Zend_Validate
 */
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Validate.php';
...
class Zend_Filter_Input
{
    ...
    public function setPluginLoader(Zend_Loader_PluginLoader_Interface $loader, $type)
    {
        ...
        switch ($type) {
            ...
            case self::VALIDATE:
                ...
                return $this;
            default:
                require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Filter/Exception.php';
        ...
        if (!isset($this->_loaders[$type])) {
            switch ($type) {
                case self::FILTER:
                    ...
                    $pathSegment   = sfConfig::get('sf_lib_dir').'/vendor/Zend/Filter/';
                    break;
                case self::VALIDATE:
                    $prefixSegment = 'Zend_Validate_';
                    $pathSegment   = sfConfig::get('sf_lib_dir').'/vendor/Zend/Validate/';
                    break;
                default:
                    require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Filter/Exception.php';
    ...
    public function setTranslator($translator = null)
    {
        if ((null === $translator) || ($translator instanceof Zend_Translate_Adapter)) {
            ...
            require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Validate/Exception.php';
