...
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Amf/Parse/Amf0/Serializer.php';
...
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Amf/Parse/Amf0/Deserializer.php';
