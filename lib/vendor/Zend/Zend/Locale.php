...
class Zend_Locale
{
    ...
    public static function setDefault($locale, $quality = 1)
    {
        if (($locale === 'auto') or ($locale === 'root') or ($locale === 'default') or
            ...
            require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Locale/Exception.php';
    ...
    public static function getEnvironment()
    {
        ...
        require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Locale/Data/Translation.php';
    ...
    {
        require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Locale/Data.php';
