    ...
    public static function cmapWithTypeData($cmapType, $cmapData)
    {
        switch ($cmapType) {
            case Zend_Pdf_Cmap::TYPE_BYTE_ENCODING:
                require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Pdf/Cmap/ByteEncoding.php';
                return new Zend_Pdf_Cmap_ByteEncoding($cmapData);

            case Zend_Pdf_Cmap::TYPE_BYTE_ENCODING_STATIC:
                require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Pdf/Cmap/ByteEncoding/Static.php';
            ...
            case Zend_Pdf_Cmap::TYPE_SEGMENT_TO_DELTA:
                require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Pdf/Cmap/SegmentToDelta.php';
                return new Zend_Pdf_Cmap_SegmentToDelta($cmapData);

            case Zend_Pdf_Cmap::TYPE_TRIMMED_TABLE:
                require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Pdf/Cmap/TrimmedTable.php';
