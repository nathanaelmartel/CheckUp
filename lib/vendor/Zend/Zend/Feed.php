...
class Zend_Feed
{
    ...
    public static function importString($string)
    {
        ...
        if ($doc->getElementsByTagName('feed')->item(0) ||
             ...
             * @see Zend_Feed_Atom
             */
            require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Feed/Atom.php';
        ...
        if ($doc->getElementsByTagName('channel')->item(0)) {
             ...
             * @see Zend_Feed_Rss
             */
            require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Feed/Rss.php';
    ...
    public static function importArray(array $data, $format = 'atom')
    {
         ...
         */
        require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Feed/Builder.php';
