 ...
 * @see Zend_Tag_Item
 */
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Tag/Item.php';
...
class Zend_Tag_Cloud
{
    ...
    public function setTags(array $tags)
    {
        ...
        foreach ($tags as $tag) {
            if ($tag instanceof Zend_Tag_Taggable) {
                ...
                require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Tag/Cloud/Exception.php';
    ...
    {
        if (null === $this->_tags) {
            require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Tag/ItemList.php';
    ...
    public function getPluginLoader()
    {
        if ($this->_pluginLoader === null) {
            ...
            $pathPrefix = sfConfig::get('sf_lib_dir').'/vendor/Zend/Tag/Cloud/Decorator/';
