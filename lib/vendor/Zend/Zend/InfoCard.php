 ...
 */
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/InfoCard/Xml/EncryptedData.php';

/**
 * Zend_InfoCard_Xml_Assertion
 */
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/InfoCard/Xml/Assertion.php';

/**
 * Zend_InfoCard_Cipher
 */
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/InfoCard/Cipher.php';

/**
 * Zend_InfoCard_Xml_Security
 */
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/InfoCard/Xml/Security.php';

/**
 * Zend_InfoCard_Adapter_Interface
 */
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/InfoCard/Adapter/Interface.php';

/**
 * Zend_InfoCard_Claims
 */
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/InfoCard/Claims.php';
...
class Zend_InfoCard
{
    ...
    public function __construct()
    {
        ...
        if(!extension_loaded('mcrypt')) {
            require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/InfoCard/Exception.php';
    ...
    public function getAdapter()
    {
        if($this->_adapter === null) {
            require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/InfoCard/Adapter/Default.php';
