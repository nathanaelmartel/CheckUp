 ...
 */
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Translate/Adapter.php';
...
class Zend_Translate {
    ...
    public function setAdapter($options = array())
    {
        ...
        if (Zend_Loader::isReadable(sfConfig::get('sf_lib_dir').'/vendor/Zend/Translate/Adapter/' . ucfirst($options['adapter']). '.php')) {
