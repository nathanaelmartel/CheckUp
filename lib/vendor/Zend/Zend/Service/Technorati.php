...
class Zend_Service_Technorati
{
    ...
    public function cosmos($url, $options = null)
    {
         ...
         */
        require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Service/Technorati/CosmosResultSet.php';
    ...
    public function search($query, $options = null)
    {
         ...
         */
        require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Service/Technorati/SearchResultSet.php';
    ...
    public function tag($tag, $options = null)
    {
         ...
         */
        require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Service/Technorati/TagResultSet.php';
    ...
    public function dailyCounts($query, $options = null)
    {
         ...
         */
        require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Service/Technorati/DailyCountsResultSet.php';
    ...
    public function topTags($options = null)
    {
         ...
         */
        require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Service/Technorati/TagsResultSet.php';
    ...
    public function blogInfo($url, $options = null)
    {
         ...
         */
        require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Service/Technorati/BlogInfoResult.php';
    ...
    public function getInfo($username, $options = null)
    {
         ...
         */
        require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Service/Technorati/GetInfoResult.php';
    ...
    public function keyInfo()
    {
         ...
         */
        require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Service/Technorati/KeyInfoResult.php';
    ...
    public function getRestClient()
    {
        if ($this->_restClient === null) {
             ...
             */
            require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Rest/Client.php';
    ...
    protected function _validateDailyCounts(array $options)
    {
        ...
        if (isset($options['days'])) {
            ...
            if ($options['days'] < self::PARAM_DAYS_MIN_VALUE ||
                 ...
                 */
                require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Service/Technorati/Exception.php';
