...
class Zend_Service_Amazon_S3 extends Zend_Service_Amazon_Abstract
{
    ...
    public function setEndpoint($endpoint)
    {
        ...
        if (!$endpoint->valid()) {
             ...
             */
            require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Service/Amazon/S3/Exception.php';
    ...
    public function registerStreamWrapper($name='s3')
    {
         ...
         */
        require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Service/Amazon/S3/Stream.php';
