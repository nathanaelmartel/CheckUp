 ...
 */
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Service/Amazon/Abstract.php';

/**
 * @see Zend_Service_Amazon_Ec2_Response
 */
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Service/Amazon/Ec2/Response.php';

/**
 * @see Zend_Service_Amazon_Ec2_Exception
 */
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Service/Amazon/Ec2/Exception.php';
...
abstract class Zend_Service_Amazon_Ec2_Abstract extends Zend_Service_Amazon_Abstract
{
    ...
    protected function signParameters(array $paramaters)
    {
        ...
        require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Crypt/Hmac.php';
