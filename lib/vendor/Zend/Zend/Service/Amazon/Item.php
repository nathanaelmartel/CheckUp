...
class Zend_Service_Amazon_Item
{
    ...
    {
    	if (null === $dom) {
    		require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Service/Amazon/Exception.php';
        ...
        foreach (array('SmallImage', 'MediumImage', 'LargeImage') as $im) {
            ...
            if ($result->length == 1) {
                 ...
                 */
                require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Service/Amazon/Image.php';
        ...
        if ($result->length >= 1) {
             ...
             */
            require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Service/Amazon/CustomerReview.php';
        ...
        if ($result->length >= 1) {
             ...
             */
            require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Service/Amazon/EditorialReview.php';
            foreach ($result as $r) {
        ...
        if ($result->length >= 1) {
             ...
             */
            require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Service/Amazon/SimilarProduct.php';
            foreach ($result as $r) {
        ...
        if ($result->length >= 1) {
             ...
             */
            require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Service/Amazon/ListmaniaList.php';
            foreach ($result as $r) {
        ...
        if ($result->length > 1 || $resultSummary->length == 1) {
             ...
             */
            require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Service/Amazon/OfferSet.php';
        ...
        if ($result->length > 1) {
             ...
             */
            require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Service/Amazon/Accessories.php';
            foreach ($result as $r) {
