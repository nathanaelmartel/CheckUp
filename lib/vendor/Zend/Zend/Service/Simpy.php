...
class Zend_Service_Simpy
{
    ...
    public function getTags($limit = null)
    {
         ...
         */
        require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Service/Simpy/TagSet.php';
    ...
    public function getLinks(Zend_Service_Simpy_LinkQuery $q = null)
    {
         ...
         */
        require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Service/Simpy/LinkSet.php';
    ...
    public function getWatchlists()
    {
         ...
         */
        require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Service/Simpy/WatchlistSet.php';
    ...
    public function getWatchlist($watchlistId)
    {
         ...
         */
        require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Service/Simpy/Watchlist.php';
    ...
    public function getNotes($q = null, $limit = null)
    {
         ...
         */
        require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Service/Simpy/NoteSet.php';
