...
class Zend_Service_Technorati_CosmosResultSet extends Zend_Service_Technorati_ResultSet
{
    ...
    public function __construct(DomDocument $dom, $options = array())
    {
        ...
        if ($result->length == 1) {
             ...
             */
            require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Service/Technorati/Weblog.php';
    ...
    public function current()
    {
         ...
         */
        require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Service/Technorati/CosmosResult.php';
