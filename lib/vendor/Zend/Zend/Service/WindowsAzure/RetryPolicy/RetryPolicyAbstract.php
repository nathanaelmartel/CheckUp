 ...
 */
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Service/WindowsAzure/RetryPolicy/NoRetry.php';

/**
 * @see Zend_Service_WindowsAzure_RetryPolicy_RetryN
 */
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Service/WindowsAzure/RetryPolicy/RetryN.php';
