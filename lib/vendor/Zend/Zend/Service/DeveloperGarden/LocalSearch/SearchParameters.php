...
class Zend_Service_DeveloperGarden_LocalSearch_SearchParameters
{
    ...
    public function setHits($hits = 10)
    {
        ...
        if (!$validator->isValid($hits)) {
            ...
            require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Service/DeveloperGarden/LocalSearch/Exception.php';
    ...
    {
        require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Validate/NotEmpty.php';
