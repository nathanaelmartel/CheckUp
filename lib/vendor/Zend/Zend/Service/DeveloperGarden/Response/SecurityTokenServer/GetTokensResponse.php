 ...
 */
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Service/DeveloperGarden/Response/ResponseAbstract.php';

/**
 * @see Zend_Service_DeveloperGarden_Response_SecurityTokenServer_Interface
 */
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Service/DeveloperGarden/Response/SecurityTokenServer/Interface.php';
    ...
    implements Zend_Service_DeveloperGarden_Response_SecurityTokenServer_Interface
{
    ...
    public function getSecurityToken()
    {
        if (!$this->securityToken instanceof Zend_Service_DeveloperGarden_Response_SecurityTokenServer_SecurityTokenResponse) {
            require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Service/DeveloperGarden/Response/SecurityTokenServer/Exception.php';
