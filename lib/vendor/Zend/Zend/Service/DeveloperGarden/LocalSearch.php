 ...
 */
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Service/DeveloperGarden/Response/LocalSearch/LocalSearchResponseType.php';

/**
 * @see Zend_Service_DeveloperGarden_Request_LocalSearch_LocalSearchRequest
 */
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Service/DeveloperGarden/Request/LocalSearch/LocalSearchRequest.php';

/**
 * @see Zend_Service_DeveloperGarden_Response_LocalSearch_LocalSearchResponse
 */
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Service/DeveloperGarden/Response/LocalSearch/LocalSearchResponse.php';

/**
 * @see Zend_Service_DeveloperGarden_LocalSearch_SearchParameters
 */
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Service/DeveloperGarden/LocalSearch/SearchParameters.php';
