 ...
 */
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Service/Yahoo/ResultSet.php';


/**
 * @see Zend_Service_Yahoo_WebResult
 */
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Service/Yahoo/InlinkDataResult.php';
