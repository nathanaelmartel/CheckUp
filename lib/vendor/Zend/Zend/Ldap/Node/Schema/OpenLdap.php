 ...
 */
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Ldap/Node/Schema/AttributeType/OpenLdap.php';
/**
 * @see Zend_Ldap_Node_Schema_ObjectClass_OpenLdap
 */
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Ldap/Node/Schema/ObjectClass/OpenLdap.php';
