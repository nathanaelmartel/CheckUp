 ...
 */
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Ldap/Node/Schema/Item.php';
/**
 * @see Zend_Ldap_Node_Schema_AttributeType_Interface
 */
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Ldap/Node/Schema/AttributeType/Interface.php';
