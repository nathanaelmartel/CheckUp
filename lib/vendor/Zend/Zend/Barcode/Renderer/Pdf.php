...
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Barcode/Renderer/RendererAbstract.php';
...
class Zend_Barcode_Renderer_Pdf extends Zend_Barcode_Renderer_RendererAbstract
{
    ...
    public function setResource($pdf, $page = 0)
    {
        if (!$pdf instanceof Zend_Pdf) {
            require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Barcode/Renderer/Exception.php';
