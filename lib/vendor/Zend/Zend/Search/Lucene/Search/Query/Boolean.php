...
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Search/Lucene/Search/Query.php';
...
class Zend_Search_Lucene_Search_Query_Boolean extends Zend_Search_Lucene_Search_Query
{
    ...
    {
        require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Search/Lucene/Search/Weight/Boolean.php';
    ...
    public function execute(Zend_Search_Lucene_Interface $reader, $docsFilter = null)
    {
        ...
        if ($docsFilter === null) {
            ...
            require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Search/Lucene/Index/DocsFilter.php';
