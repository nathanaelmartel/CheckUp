...
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Search/Lucene/Analysis/Token.php';

/** Zend_Search_Lucene_Analysis_TokenFilter */
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Search/Lucene/Analysis/TokenFilter.php';
