...
class Zend_Search_Lucene_Index_Writer
{
    ...
    public function addDocument(Zend_Search_Lucene_Document $document)
    {
        ...
        require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Search/Lucene/Index/SegmentWriter/DocumentWriter.php';
    ...
    private function _mergeSegments($segments)
    {
        ...
        require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Search/Lucene/Index/SegmentMerger.php';
