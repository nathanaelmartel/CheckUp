 ...
 */
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Crypt/Rsa/Key.php';
...
class Zend_Crypt_Rsa_Key_Private extends Zend_Crypt_Rsa_Key
{
    ...
    protected function _parse($passPhrase)
    {
        ...
        if (!$result) {
             ...
             */
            require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Crypt/Exception.php';
    ...
    public function getPublicKey()
    {
        if (is_null($this->_publicKey)) {
             ...
             */
            require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Crypt/Rsa/Key/Public.php';
