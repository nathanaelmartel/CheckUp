 ...
 */
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Mail/Transport/Abstract.php';

/**
 * @see Zend_Mime
 */
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Mime.php';

/**
 * @see Zend_Mime_Message
 */
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Mime/Message.php';

/**
 * @see Zend_Mime_Part
 */
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Mime/Part.php';
...
class Zend_Mail extends Zend_Mime_Message
{
    ...
    public function setType($type)
    {
        ...
        if (!in_array($type, $allowed)) {
             ...
             */
            require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Mail/Exception.php';
    ...
    public function send($transport = null)
    {
        if ($transport === null) {
            if (! self::$_defaultTransport instanceof Zend_Mail_Transport_Abstract) {
                require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Mail/Transport/Sendmail.php';
