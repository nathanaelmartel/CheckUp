...
abstract class Zend_File_Transfer_Adapter_Abstract
{
    ...
    {
        require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/File/Transfer/Exception.php';
        ...
        switch ($type) {
            ...
            case self::VALIDATE:
                ...
                if (!isset($this->_loaders[$type])) {
                    $paths         = array(
                        'Zend_' . $prefixSegment . '_'     => sfConfig::get('sf_lib_dir').'/vendor/Zend/' . $pathSegment . '/',
                        'Zend_' . $prefixSegment . '_File' => sfConfig::get('sf_lib_dir').'/vendor/Zend/' . $pathSegment . '/File',
                    );
