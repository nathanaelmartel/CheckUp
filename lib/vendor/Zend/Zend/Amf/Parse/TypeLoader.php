 ...
 */
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Amf/Value/Messaging/AsyncMessage.php';
/**
 ...
 */
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Amf/Value/Messaging/RemotingMessage.php';
...
final class Zend_Amf_Parse_TypeLoader
{
    ...
    {
        if(!self::$_resourceLoader) {
            require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Amf/Exception.php';
