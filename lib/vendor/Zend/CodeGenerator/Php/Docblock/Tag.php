 ...
 */
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/CodeGenerator/Php/Docblock/Tag/Param.php';

/**
 * @see Zend_CodeGenerator_Php_Docblock_Tag_Return
 */
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/CodeGenerator/Php/Docblock/Tag/Return.php';
