 ...
 */
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/View/Helper/Navigation/HelperAbstract.php';
    ...
    extends Zend_View_Helper_Navigation_HelperAbstract
{
    ...
    public function setServerUrl($serverUrl)
    {
        ...
        if ($uri->valid()) {
            ...
            require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Uri/Exception.php';
    ...
    public function getDomSitemap(Zend_Navigation_Container $container = null)
    {
        ...
        if ($this->getUseSitemapValidators()) {
            require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Validate/Sitemap/Changefreq.php';
            require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Validate/Sitemap/Lastmod.php';
            require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Validate/Sitemap/Loc.php';
            require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Validate/Sitemap/Priority.php';
        ...
        foreach ($iterator as $page) {
            ...
            if ($this->getUseSitemapValidators() &&
                ...
                require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/View/Exception.php';
