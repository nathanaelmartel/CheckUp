...
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Feed/Pubsubhubbub/Model/ModelAbstract.php';

/** @see Zend_Feed_Pubsubhubbub_Model_SubscriptionInterface */
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Feed/Pubsubhubbub/Model/SubscriptionInterface.php';
