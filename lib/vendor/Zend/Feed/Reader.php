 ...
 */
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Feed/Reader/Feed/Rss.php';

/**
 * @see Zend_Feed_Reader_Feed_Atom
 */
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Feed/Reader/Feed/Atom.php';

/**
 * @see Zend_Feed_Reader_FeedSet
 */
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Feed/Reader/FeedSet.php';
    ...
    public static function getPluginLoader()
    {
        if (!isset(self::$_pluginLoader)) {
            ...
            self::$_pluginLoader = new Zend_Loader_PluginLoader(array(
                'Zend_Feed_Reader_Extension_' => sfConfig::get('sf_lib_dir').'/vendor/Zend/Feed/Reader/Extension/',
            ));
        }
