 ...
 */
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Feed/Reader/Extension/EntryAbstract.php';
 ...
 */
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Feed/Reader/Feed/Atom/Source.php';
