 ...
 */
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Feed/Builder/Interface.php';

/**
 * @see Zend_Feed_Builder_Header
 */
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Feed/Builder/Header.php';

/**
 * @see Zend_Feed_Builder_Entry
 */
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Feed/Builder/Entry.php';
