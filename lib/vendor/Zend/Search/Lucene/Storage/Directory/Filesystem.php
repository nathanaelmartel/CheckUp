...
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Search/Lucene/Storage/Directory.php';
...
class Zend_Search_Lucene_Storage_Directory_Filesystem extends Zend_Search_Lucene_Storage_Directory
{
    ...
    public function createFile($filename)
    {
        ...
        require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Search/Lucene/Storage/File/Filesystem.php';
