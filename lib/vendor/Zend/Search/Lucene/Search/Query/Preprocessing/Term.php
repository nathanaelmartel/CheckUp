...
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Search/Lucene/Search/Query/Preprocessing.php';
...
class Zend_Search_Lucene_Search_Query_Preprocessing_Term extends Zend_Search_Lucene_Search_Query_Preprocessing
{
    ...
    public function rewrite(Zend_Search_Lucene_Interface $index)
    {
        if ($this->_field === null) {
            ...
            require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Search/Lucene/Search/Query/Preprocessing/Term.php';
