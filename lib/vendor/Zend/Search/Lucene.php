...
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Search/Lucene/Document/Html.php';

/** Zend_Search_Lucene_Document_Docx */
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Search/Lucene/Document/Docx.php';

/** Zend_Search_Lucene_Document_Pptx */
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Search/Lucene/Document/Pptx.php';

/** Zend_Search_Lucene_Document_Xlsx */
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Search/Lucene/Document/Xlsx.php';

/** Zend_Search_Lucene_Search_QueryParser */
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Search/Lucene/Search/QueryParser.php';

/** Zend_Search_Lucene_Search_QueryHit */
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Search/Lucene/Search/QueryHit.php';

/** Zend_Search_Lucene_Analysis_Analyzer */
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Search/Lucene/Analysis/Analyzer.php';

/** Zend_Search_Lucene_Search_Query_Term */
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Search/Lucene/Search/Query/Term.php';

/** Zend_Search_Lucene_Search_Query_Phrase */
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Search/Lucene/Search/Query/Phrase.php';

/** Zend_Search_Lucene_Search_Query_MultiTerm */
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Search/Lucene/Search/Query/MultiTerm.php';

/** Zend_Search_Lucene_Search_Query_Wildcard */
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Search/Lucene/Search/Query/Wildcard.php';

/** Zend_Search_Lucene_Search_Query_Range */
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Search/Lucene/Search/Query/Range.php';

/** Zend_Search_Lucene_Search_Query_Fuzzy */
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Search/Lucene/Search/Query/Fuzzy.php';

/** Zend_Search_Lucene_Search_Query_Boolean */
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Search/Lucene/Search/Query/Boolean.php';

/** Zend_Search_Lucene_Search_Query_Empty */
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Search/Lucene/Search/Query/Empty.php';

/** Zend_Search_Lucene_Search_Query_Insignificant */
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Search/Lucene/Search/Query/Insignificant.php';
...
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Search/Lucene/Interface.php';

/** Zend_Search_Lucene_Index_SegmentInfo */
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Search/Lucene/Index/SegmentInfo.php';

/** Zend_Search_Lucene_LockManager */
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Search/Lucene/LockManager.php';
...
class Zend_Search_Lucene implements Zend_Search_Lucene_Interface
{
    ...
    public static function create($directory)
    {
        ...
        require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Search/Lucene/Proxy.php';
    ...
    public static function getActualGeneration(Zend_Search_Lucene_Storage_Directory $directory)
    {
        ...
        require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Search/Lucene/Exception.php';
        try {
    ...
    public function __construct($directory = null, $create = false)
    {
        ...
        if (is_string($directory)) {
            require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Search/Lucene/Storage/Directory/Filesystem.php';
        ...
        if ($create) {
            ...
            require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Search/Lucene/Index/Writer.php';
    ...
    public function getSimilarity()
    {
        ...
        require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Search/Lucene/Search/Similarity.php';
    ...
    public function terms()
    {
        ...
        require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Search/Lucene/Index/TermsPriorityQueue.php';
    ...
    public function resetTermsStream()
    {
        if ($this->_termsStream === null) {
            ...
            require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Search/Lucene/TermStreamsPriorityQueue.php';
