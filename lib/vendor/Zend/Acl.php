 ...
 */
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Acl/Resource/Interface.php';


/**
 * @see Zend_Acl_Role_Registry
 */
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Acl/Role/Registry.php';


/**
 * @see Zend_Acl_Assert_Interface
 */
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Acl/Assert/Interface.php';


/**
 * @see Zend_Acl_Role
 */
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Acl/Role.php';
...
class Zend_Acl
{
    ...
    public function addRole($role, $parents = null)
    {
        ...
        if (!$role instanceof Zend_Acl_Role_Interface) {
            require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Acl/Exception.php';
