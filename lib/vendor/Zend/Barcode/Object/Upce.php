 ...
 */
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Barcode/Object/Ean13.php';

/**
 * @see Zend_Validate_Barcode
 */
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Validate/Barcode.php';
...
class Zend_Barcode_Object_Upce extends Zend_Barcode_Object_Ean13
{
    ...
    protected function _validateText($value, $options = array())
    {
        ...
        if (!$validator->isValid($value)) {
             ...
             */
            require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Barcode/Object/Exception.php';
