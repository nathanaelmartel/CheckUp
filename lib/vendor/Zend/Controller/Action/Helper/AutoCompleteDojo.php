 ...
 */
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Controller/Action/Helper/AutoComplete/Abstract.php';
...
class Zend_Controller_Action_Helper_AutoCompleteDojo extends Zend_Controller_Action_Helper_AutoComplete_Abstract
{
    ...
    public function prepareAutoCompletion($data, $keepLayouts = false)
    {
        if (!$data instanceof Zend_Dojo_Data) {
            require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Dojo/Data.php';
            $items = array();
