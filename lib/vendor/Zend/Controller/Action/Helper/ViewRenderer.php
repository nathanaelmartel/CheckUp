 ...
 */
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Controller/Action/Helper/Abstract.php';
...
class Zend_Controller_Action_Helper_ViewRenderer extends Zend_Controller_Action_Helper_Abstract
{
    ...
    public function getInflector()
    {
        if (null === $this->_inflector) {
             ...
             */
            require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Filter/Inflector.php';
            /**
             * @see Zend_Filter_PregReplace
             */
            require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Filter/PregReplace.php';
            /**
             * @see Zend_Filter_Word_UnderscoreToSeparator
             */
            require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Filter/Word/UnderscoreToSeparator.php';
