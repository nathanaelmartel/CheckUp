 ...
 */
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Controller/Action/HelperBroker/PriorityStack.php';
    ...
    public static function getPluginLoader()
    {
        if (null === self::$_pluginLoader) {
            ...
            self::$_pluginLoader = new Zend_Loader_PluginLoader(array(
                'Zend_Controller_Action_Helper' => sfConfig::get('sf_lib_dir').'/vendor/Zend/Controller/Action/Helper/',
            ));
        }
