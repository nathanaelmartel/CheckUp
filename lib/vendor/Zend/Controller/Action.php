 ...
 */
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Controller/Action/Interface.php';
...
abstract class Zend_Controller_Action implements Zend_Controller_Action_Interface
{
    ...
    public function initView()
    {
        ...
        require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/View/Interface.php';
        ...
        require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/View.php';
    ...
    {
        require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Controller/Action/Exception.php';
