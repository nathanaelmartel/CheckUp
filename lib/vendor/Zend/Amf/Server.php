...
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Server/Interface.php';

/** @see Zend_Server_Reflection */
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Server/Reflection.php';

/** @see Zend_Amf_Constants */
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Amf/Constants.php';

/** @see Zend_Amf_Value_MessageBody */
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Amf/Value/MessageBody.php';

/** @see Zend_Amf_Value_MessageHeader */
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Amf/Value/MessageHeader.php';

/** @see Zend_Amf_Value_Messaging_CommandMessage */
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Amf/Value/Messaging/CommandMessage.php';

/** @see Zend_Loader_PluginLoader */
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Loader/PluginLoader.php';

/** @see Zend_Amf_Parse_TypeLoader */
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Amf/Parse/TypeLoader.php';

/** @see Zend_Auth */
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Auth.php';
/**
...
class Zend_Amf_Server implements Zend_Server_Interface
{
   ...
   /**
    ...
    {
        require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Session.php';
        $this->_session = true;
    ...
    protected function _checkAcl($object, $function)
    {
        ...
        if($object) {
            ...
            if(!$this->_acl->has($class)) {
                require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Acl/Resource.php';
        ...
        if($auth->hasIdentity()) {
            ...
            if($this->_acl->hasRole(Zend_Amf_Constants::GUEST_ROLE)) {
                ...
                require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Amf/Server/Exception.php';
    ...
    {
        require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Amf/Value/Messaging/AcknowledgeMessage.php';
    ...
    protected function _errorMessage($objectEncoding, $message, $description, $detail, $code, $line)
    {
        ...
        switch ($objectEncoding) {
            ...
            case Zend_Amf_Constants::AMF3_OBJECT_ENCODING :
                require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Amf/Value/Messaging/ErrorMessage.php';
    ...
    public function getRequest()
    {
        if (null === $this->_request) {
            require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Amf/Request/Http.php';
    ...
    public function getResponse()
    {
        if (null === ($response = $this->_response)) {
            require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Amf/Response/Http.php';
