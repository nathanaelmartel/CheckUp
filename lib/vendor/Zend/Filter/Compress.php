 ...
 */
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Filter/Interface.php';
...
class Zend_Filter_Compress implements Zend_Filter_Interface
{
    ...
    public function getAdapter()
    {
        ...
        if (!class_exists($adapter)) {
            ...
            if (Zend_Loader::isReadable(sfConfig::get('sf_lib_dir').'/vendor/Zend/Filter/Compress/' . ucfirst($adapter) . '.php')) {
