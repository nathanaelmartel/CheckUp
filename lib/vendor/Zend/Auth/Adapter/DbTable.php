 ...
 */
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Auth/Adapter/Interface.php';
 ...
 */
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Auth/Result.php';
...
class Zend_Auth_Adapter_DbTable implements Zend_Auth_Adapter_Interface
{
    ...
    protected function _setDbAdapter(Zend_Db_Adapter_Abstract $zendDb = null)
    {
        ...
        if(null === $this->_zendDb) {
            require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Db/Table/Abstract.php';
            $this->_zendDb = Zend_Db_Table_Abstract::getDefaultAdapter();
            if (null === $this->_zendDb) {
                require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Auth/Adapter/Exception.php';
