 ...
 * @see Zend_Json
 */
require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Json.php';
        ...
        if ($data instanceof Zend_Paginator_AdapterAggregate) {
            ...
            if ($adapter == self::INTERNAL_ADAPTER) {
                if (is_array($data)) {
                     ...
                     */
                    require_once sfConfig::get('sf_lib_dir').'/vendor/Zend/Paginator/Exception.php';
    ...
    public static function getAdapterLoader()
    {
        if (self::$_adapterLoader === null) {
            self::$_adapterLoader = new Zend_Loader_PluginLoader(
                array('Zend_Paginator_Adapter' => sfConfig::get('sf_lib_dir').'/vendor/Zend/Paginator/Adapter')
            );
        }
    ...
    public static function getScrollingStyleLoader()
    {
        if (self::$_scrollingStyleLoader === null) {
            self::$_scrollingStyleLoader = new Zend_Loader_PluginLoader(
                array('Zend_Paginator_ScrollingStyle' => sfConfig::get('sf_lib_dir').'/vendor/Zend/Paginator/ScrollingStyle')
            );
        }
